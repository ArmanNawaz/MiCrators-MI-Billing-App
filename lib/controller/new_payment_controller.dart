  ...
  loadItem(serialNo) async{
    ...
    if(stockBox.containsKey(serialNo)){
      ...
      for(int i = 0; i < data['warranty'].length; i++){
        warranties.add(
          WarrantyModel(warranty_name: data['warranty'][0]['warranty_name'],
              warranty_id: data['warranty'][0]['warranty_id'],
              warranty_type: data['warranty'][0]['warranty_type'],
              days_valid: data['warranty'][0]['days_valid'],
          )
        );
      }
      // print(warranties);
